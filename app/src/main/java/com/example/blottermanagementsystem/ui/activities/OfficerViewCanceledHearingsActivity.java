...
public class OfficerViewCanceledHearingsActivity extends BaseActivity {
    ...
    private String currentFilter = "Canceled";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            android.util.Log.d("OfficerViewCanceledHearings", "Starting onCreate...");
            setContentView(R.layout.activity_officer_canceled_hearings);
            ...
            android.util.Log.d("OfficerViewCanceledHearings", "onCreate completed successfully");
        } catch (Exception e) {
            android.util.Log.e("OfficerViewCanceledHearings", "Error in onCreate: " + e.getMessage(), e);
            showErrorState();
        }
    }
    ...
    private void initializeViews() {
        try {
            ...
            android.util.Log.e("OfficerViewCanceledHearings", "Error initializing views: " + e.getMessage());
        }
    }
    ...
    private void setupListeners() {
        try {
            ...
            android.util.Log.e("OfficerViewCanceledHearings", "Error setting up listeners: " + e.getMessage());
        }
    }
    ...
    private void loadHearings() {
        try {
            Executors.newSingleThreadExecutor().execute(() -> {
                try {
                    List<Hearing> hearings = hearingDao.getCanceledHearings();
                    runOnUiThread(() -> {
                        allHearings.clear();
                    ...
                    android.util.Log.e("OfficerViewCanceledHearings", "Error loading hearings: " + e.getMessage());
                    runOnUiThread(this::updateEmptyState);
                }
            });
        } catch (Exception e) {
            android.util.Log.e("OfficerViewCanceledHearings", "Error in loadHearings: " + e.getMessage());
            updateEmptyState();
        }
    }
    ...
    private void filterAndDisplayHearings() {
        try {
            ...
            for (Hearing hearing : allHearings) {
                if (currentFilter.equals("All") || currentFilter.equals("Canceled")) {
            ...
            android.util.Log.e("OfficerViewCanceledHearings", "Error filtering hearings: " + e.getMessage());
        }
    }
    ...
    private void updateEmptyState() {
        try {
            ...
            android.util.Log.e("OfficerViewCanceledHearings", "Error updating empty state: " + e.getMessage());
        }
    }
    ...
    private void updateEmptyStateMessage() {
        try {
            if (emptyStateTitle != null) {
                emptyStateTitle.setText("No Canceled Hearings");
            }
            if (emptyStateMessage != null) {
                emptyStateMessage.setText("Canceled hearings will appear here.");
            }
        } catch (Exception e) {
            android.util.Log.e("OfficerViewCanceledHearings", "Error updating empty state message: " + e.getMessage());
        }
    }
    ...
    private void showErrorState() {
        try {
            ...
            android.util.Log.e("OfficerViewCanceledHearings", "Error showing error state: " + e.getMessage());
        }
    }
}
